...
function NewRewardWindow(tabGroup, reward) {'use strict';
    ...
    var soundWin = Titanium.Media.createSound({
        url : '/sounds/gain.mp3'
    });
    var soundOpen = Titanium.Media.createSound({
        url : '/sounds/ouverture.mp3'
    });
    ...
    var LoginView = require("/ui/common/LoginView"), loginView = new LoginView(tabGroup, lblLoginAction, onClose);
    loginView.top = 480;
    view.add(loginView);
