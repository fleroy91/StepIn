 ...
 */
Geo.parseDMS = function(dmsStr) {'use strict';
 ...
 */
Geo.toLat = function(deg, format, dp) { 'use strict';
 ...
 * @returns {String} Deg/min/seconds
 */
Geo.toLon = function(deg, format, dp) { 'use strict';
 ...
 * @returns {String} Deg/min/seconds
 */
Geo.toBrng = function(deg, format, dp) { 'use strict';
